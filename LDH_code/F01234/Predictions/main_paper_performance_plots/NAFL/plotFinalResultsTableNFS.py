...
data = np.array([[50.0, 88.1, 67.3, 78.3, 75.6, 70.7, 55.1, 63.9],
                 [50.0, 88.1, 67.3, 78.3, 75.6, 75.4, 68.1, 63.9],
                 [72.7, 61.1, 69.6, 64.7, 67.5, 73.6, 77.8, 36.1]])
...
rows = ['%s' % x for x in ('NFS-DET: NFS(-1.455, 0.675)', 'NFS-DET: ENS(0.585, 0.585)', 'NFS-INDET: ENS(0.585, 0.585)')]

# Get some pastel shades for the colors
colors = ['yellow', 'red', 'darksalmon']
...
plt.bar(index2 - bar_width, data[0,:], bar_width, color=colors[0], linewidth=1, edgecolor='black') # FIB4 Performance Metrics
