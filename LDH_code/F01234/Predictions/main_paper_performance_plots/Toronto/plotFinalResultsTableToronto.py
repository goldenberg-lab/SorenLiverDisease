...
APRI = np.array([[37.8, 88.1, 77.3, 56.9, 62.1, 71.9, 64.3, 100-16.4],
                 [71.1, 88.1, 86.5, 74.0, 79.3, 87.6, 87.4, 100-16.4],
                 [90.0, 57.1, 75.0, 80.0, 76.5, 84.3, 89.9, 16.4]])

FIB4 = np.array([[66.7, 82.1, 77.4, 72.7, 74.7, 82.5, 82.2, 72.1],
                 [75.0, 84.6, 81.8, 78.6, 80.0, 88.2, 88.1, 72.1],
                 [94.7, 60.0, 81.8, 85.7, 82.8, 81.1, 87.3, 27.9]])
