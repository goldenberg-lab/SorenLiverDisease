...
ENS = MLA('ENS', 0.6, dataset['ENS1_probs'], dataset['Fibrosis'])
ENS.color = 'red'
...
algs = [FIB4]
#algs = [APRI, FIB4, ENS]# , FIB4
#algs = [SVM, RFC, GBC, LOG, MLP]
...
fields = ['reckey_enc', 'SVM_probs', 'RFC_probs', 'GBC_probs', 'LOG_probs', 'MLP_probs', 'APRI_vals', 'FIB4_vals', 
          'NAFL_vals', 'TE_vals', 'ENS1_probs',  'APRI_probs', 'FIB4_probs', 'orig_fibrosis']
...
# res_path = thesis_path + '/Code/Lancet Digital Health Code/F01234/Predictions/predictions/'
